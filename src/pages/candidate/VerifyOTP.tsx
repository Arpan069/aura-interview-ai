        ...
        >
          <div className="glass-card rounded-xl p-8 shadow-xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">An OTP has been sent to your email address</p>
              <p className="text-sm text-gray-500 mt-2">Please enter the code to verify your account</p>
            </div>
            ...
            <div className="text-center mt-6">
              <Link to="/candidate/register" className="text-sm text-gray-600 hover:underline">
