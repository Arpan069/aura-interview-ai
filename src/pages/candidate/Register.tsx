          ...
          >
            <div className="glass-card rounded-xl p-8 shadow-xl">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Create your account to start your interview journey</p>
              </div>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              <div className="absolute -bottom-8 left-0 right-0 text-center">
                <p className="text-lg font-semibold text-indigo-600">Your AI Interview Assistant</p>
                <p className="text-sm text-gray-600">Ready to help you succeed</p>
              </div>
            </div>
          </motion.div>
        </div>
